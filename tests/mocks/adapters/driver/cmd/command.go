...
import (
	cmd "github.com/NicklasWallgren/go-template/adapters/driver/cmd"
...
func (_e *Command_Expecter) Run(_a0 interface{}) *Command_Run_Call {
	return &Command_Run_Call{Call: _e.mock.On("Run", _a0)}
}
...
func (_m *Command) Setup(_a0 *cobra.Command) {
	_m.Called(_a0)
}
...
func (_e *Command_Expecter) Setup(_a0 interface{}) *Command_Setup_Call {
	return &Command_Setup_Call{Call: _e.mock.On("Setup", _a0)}
}
