...
func (_m *UserRepository) FindAllByCriteria(ctx context.Context, criteriaAndPagination *models.CriteriaAndPagination[users.FindAllCriteria]) (*models.Page[*entities.User], error) {
	...
	var r0 *models.Page[*entities.User]
	if rf, ok := ret.Get(0).(func(context.Context, *models.CriteriaAndPagination[users.FindAllCriteria]) *models.Page[*entities.User]); ok {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *models.CriteriaAndPagination[users.FindAllCriteria]) error); ok {
...
func (_e *UserRepository_Expecter) FindAllByCriteria(ctx interface{}, criteriaAndPagination interface{}) *UserRepository_FindAllByCriteria_Call {
	return &UserRepository_FindAllByCriteria_Call{Call: _e.mock.On("FindAllByCriteria", ctx, criteriaAndPagination)}
}

func (_c *UserRepository_FindAllByCriteria_Call) Run(run func(ctx context.Context, criteriaAndPagination *models.CriteriaAndPagination[users.FindAllCriteria])) *UserRepository_FindAllByCriteria_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*models.CriteriaAndPagination[users.FindAllCriteria]))
	})
	return _c
}
...
func (_m *UserRepository) Overview(ctx context.Context, criteriaAndPagination *models.CriteriaAndPagination[users.OverviewCriteria]) (*models.Page[*usersmodels.SenderOverview], error) {
	ret := _m.Called(ctx, criteriaAndPagination)

	var r0 *models.Page[*usersmodels.SenderOverview]
	if rf, ok := ret.Get(0).(func(context.Context, *models.CriteriaAndPagination[users.OverviewCriteria]) *models.Page[*usersmodels.SenderOverview]); ok {
		r0 = rf(ctx, criteriaAndPagination)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *models.CriteriaAndPagination[users.OverviewCriteria]) error); ok {
		r1 = rf(ctx, criteriaAndPagination)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *UserRepository_Expecter) Overview(ctx interface{}, criteriaAndPagination interface{}) *UserRepository_Overview_Call {
	return &UserRepository_Overview_Call{Call: _e.mock.On("Overview", ctx, criteriaAndPagination)}
}

func (_c *UserRepository_Overview_Call) Run(run func(ctx context.Context, criteriaAndPagination *models.CriteriaAndPagination[users.OverviewCriteria])) *UserRepository_Overview_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*models.CriteriaAndPagination[users.OverviewCriteria]))
	})
	return _c
}

func (_c *UserRepository_Overview_Call) Return(page *models.Page[*usersmodels.SenderOverview], err error) *UserRepository_Overview_Call {
	_c.Call.Return(page, err)
	return _c
}
